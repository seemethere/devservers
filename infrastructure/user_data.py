"""User data templates for EKS node bootstrapping"""

def get_gpu_user_data(cluster_name: str, cluster_endpoint: str, cluster_ca: str,
                      cluster_cidr: str, region: str, gpu_type: str) -> str:
    """Generate user data for GPU nodes with Amazon Linux 2023"""
    return f"""#!/bin/bash
...
def get_cpu_user_data(cluster_name: str, cluster_endpoint: str, cluster_ca: str,
                      cluster_cidr: str, region: str) -> str:
    """Generate user data for CPU management nodes with Amazon Linux 2023"""
    return f"""#!/bin/bash
